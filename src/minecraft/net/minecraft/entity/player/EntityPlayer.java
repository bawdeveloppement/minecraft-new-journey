      ...
      if(targetEntity.canAttackWithItem()) {
         if(!targetEntity.hitByEntity(this)) {
            ...
            if(targetEntity instanceof EntityLivingBase) {
               f1 = EnchantmentHelper.getEnchantmentModifierForCreatureAttribute(this.getHeldItem(), ((EntityLivingBase)targetEntity).getCreatureAttribute());
            } else {
               f1 = EnchantmentHelper.getEnchantmentModifierForCreatureAttribute(this.getHeldItem(), EnumCreatureAttribute.UNDEFINED);
            }
